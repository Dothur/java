...
public class Box2Test1 {
	public static void main(String args[]) {
		...
		System.out.println("mybox1.width :" + mybox1.depth);

		System.out.println("mybox2.width :" + mybox2.width);
		System.out.println("mybox2.width :" + mybox2.height);
		System.out.println("mybox2.width :" + mybox2.depth);

		Box2 mybox3 = mybox2;
		mybox2.width = 1000;
		mybox2.height = 2000;
		System.out.println("mybox3.width :" + mybox3.width);
		System.out.println("mybox3.width :" + mybox3.height);
		System.out.println("mybox3.width :" + mybox3.depth);
	}
}